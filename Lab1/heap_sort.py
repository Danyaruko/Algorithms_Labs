...
def heapify_max(array, size, parent_node):
    ...
    if max_node != parent_node:
        array[max_node], array[parent_node] = array[parent_node], array[max_node]
        swaps_counter += 1
        swaps_counter_increment, comparisons_counter_increment = heapify_max(
            array, size, max_node)
...
def heapify_min(array, size, parent_node):
    ...
    if min_node != parent_node:
        array[min_node], array[parent_node] = array[parent_node], array[min_node]
        swaps_counter += 1
        swaps_counter_increment, comparisons_counter_increment = heapify_min(
            array, size, min_node)
        swaps_counter += swaps_counter_increment
        comparisons_counter += comparisons_counter_increment
